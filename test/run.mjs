...
// real ~/.crm-r-us/ state, mirroring CI exactly. Set CRM_R_US_TEST_REAL_HOME=1 to opt out.
//
...
const sandboxHome = process.env.CRM_R_US_TEST_REAL_HOME
  ? null
  : mkdtempSync(join(tmpdir(), "crm-r-us-test-home-"));
